...
const htmlData = r'''
<div style="background-color: green;"><div style="width: 50px; height:50px; background-color: white;">a</div><br></div>
''';
// const htmlData = r'''
// <div style="background-color: green;"><div style="width: 50px; height:50px; background-color: white;">a</div><br></div>
// <div style="background-color: red;"><img width="175" alt='xkcd' src='https://imgs.xkcd.com/comics/commemorative_plaque.png' /><br></div>
// <div style="background-color: blue;"><img width="175" alt='xkcd' src='https://imgs.xkcd.com/comics/commemorative_plaque.png' />aaa<br></div>
// ''';
// const htmlData = r"""
// <p style="background-color: red;"><img width="175" alt='xkcd' src='https://imgs.xkcd.com/comics/commemorative_plaque.png' /><br></p>
...
class MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //       children: [
      //         WidgetSpan(
      //             child: Container(height: 50, width: 40, color: Colors.red)),
      //         TextSpan(
      //             text: '\n',
      //             style: TextStyle(
      //                 height: 0,
